...
import { handleGenerateContent } from "@/lib/actions/AI/AI_actions";
...
export default function Page() {
    ...
    return (
        <main className="min-h-screen bg-canvas px-4 py-6 text-body">
            <div className="mx-auto flex h-[82vh] w-full max-w-2xl flex-col text-black  border border-hairline bg-surface-soft">
                ...
                <div className="flex-1 overflow-y-auto px-4 py-4">
                    <div className="space-y-4 text-black">
                        {chatHistory.map((message) => (
                            ...
                            >
                                <div
                                    className={`max-w-[88%] rounded-lg border text-black px-3 py-2.5 text-sm leading-6 ${
                                        message.role === "user"
                                ...
                                >
                                    ...
                                    <p className="whitespace text-black-pre-wrap">{message.content}</p>
                                </div>
                            </div>
                        ))}
